ITEM.Name = "Jump I"
ITEM.Description = "Small jump increase."
ITEM.StorePrice = 60
...
function ITEM:OnSpawn(ply, id)
	...
	if (not equipped) and (not equipped1) then
		ply:SetJumpPower( Lerp(0.333, 200,230) )
	end
end
...
function ITEM:DrawBoostIcon(x,y)
	...
	draw.ShadowText("I", "Screen_Medium", x+117/2, y+28, Color(46, 204, 113), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1 )
end